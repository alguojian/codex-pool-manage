...
const translations = {
  // ─── Header ───
  'app.title': { en: 'Codex Pool Manager', zh: 'Codex 管理器' },
  'app.version': { en: 'v1.0.0', zh: 'v1.0.0' },
  ...
  'card.setActive': { en: 'Set Active', zh: '设为活跃' },
  'card.pause': { en: 'Pause', zh: '暂停' },
  'card.reset': { en: 'Reset', zh: '重置' },
  'card.refreshToken': { en: 'Refresh Token', zh: '刷新 Token' },
  'card.remove': { en: 'Remove', zh: '删除' },
  ...
  'settings.accountErrors': { en: 'Account errors', zh: '账号错误' },
  'settings.rateLimitsHit': { en: 'Rate limits hit', zh: '触发速率限制' },
  'settings.taskFailures': { en: 'Task failures', zh: '任务失败' },
  'settings.poolRotation': { en: 'Pool rotation', zh: '池轮换' },
  'settings.importExport': { en: 'Import / Export', zh: '导入 / 导出' },
  'settings.importAccounts': { en: 'Import Accounts (JSON)', zh: '导入账号 (JSON)' },
  'settings.exportAccounts': { en: 'Export All Accounts', zh: '导出所有账号' },
  'settings.importPoolConfig': { en: 'Import Pool Config', zh: '导入池配置' },
  'settings.exportPoolConfig': { en: 'Export Pool Config', zh: '导出池配置' },
  'settings.dangerZone': { en: 'Danger Zone', zh: '危险区域' },
  'settings.resetAllAccounts': { en: 'Reset All Accounts', zh: '重置所有账号' },
  'settings.clearTaskHistory': { en: 'Clear Task History', zh: '清空任务历史' },
  'settings.deleteAllData': { en: 'Delete All Data', zh: '删除所有数据' },
